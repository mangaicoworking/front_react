...
import ContentInstituicao from './pages/Instituicao/index';
...
export default function MiniDrawer() {
  ...
  // PAGE Instituicao
  const renderpageInstituicao= () => {
    if(values.pageInstituicao) {
      return (
       <ContentInstituicao />
      )
    }
  }
  const toggleInstituicao= () => {
    if(values.pageInstituicao) {
      return
    }else{
      setActivedPage('pageInstituicao');
    }
  }
  // PAGE Movimentações
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <ListItem button onClick={toggleInstituicao}>
        ...
        <ListItem button onClick={toggleGestorBeneficios}>
          ...
          <ListItemText primary="Gestor de Benefícios" />
        </ListItem>
