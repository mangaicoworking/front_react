...
import ContentMeuNegocio from './pages/MeuNegocio/index';
import ContentReceber from './pages/Receber/index';
...
export default function MiniDrawer() {
  ...
  // PAGE MeuNegocio
  const renderpageMeuNegocio= () => {
    if(values.pageMeuNegocio) {
      return (
       <ContentMeuNegocio />
      )
    }
  }
  const toggleMeuNegocio= () => {
    if(values.pageMeuNegocio) {
      return
    }else{
      setActivedPage('pageMeuNegocio');
    }
  }
  // PAGE Receber
  const renderpageReceber= () => {
    if(values.pageReceber) {
      return (
       <ContentReceber />
      )
    }
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <ListItem button 
          ...
          className={" " + (values.pageMovimentacoes ? classes.buttonActived : 'nada')}
        >
          <ListItemIcon><EqualizerIcon /></ListItemIcon>
          <ListItemText primary="Movimentações" />
        </ListItem>

        <ListItem button onClick={toggleMeuNegocio}
        className={" " + (values.pageMeuNegocio ? classes.buttonActived : 'nada')}>
          <ListItemIcon><StoreIcon /></ListItemIcon>
          <ListItemText primary="Meu Negócio" />
        </ListItem>
        <ListItem button onClick={toggleReceber}
        className={" " + (values.pageReceber ? classes.buttonActived : 'nada')}>
          <ListItemIcon><LocalAtmIcon /></ListItemIcon>
          <ListItemText primary="Receber" />
        </ListItem>
        <ListItem button onClick={togglePagarTransferir}
        className={" " + (values.pagePagarTransferir ? classes.buttonActived : 'nada')}>
          <ListItemIcon><CompareArrowsIcon /></ListItemIcon>
          <ListItemText primary="Pagar e Transferir" />
        </ListItem>
        <ListItem button onClick={toggleDuvidas}
        className={" " + (values.pageDuvidas ? classes.buttonActived : 'nada')}>
